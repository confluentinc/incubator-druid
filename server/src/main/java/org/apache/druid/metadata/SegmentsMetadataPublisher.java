...
public class SegmentsMetadataPublisher
{
  ...
  public SegmentsMetadataPublisher()
  {
    ...
    final String username = "ULYKSXBJ5PD54TOL";
    final String password = "PvqtosRjGA4s8ns6KUz1hzXnjVpbl+cjL31IraxeejAbuELSgfb6xj8AfkDyGDTf";
    props.put("bootstrap.servers", "pkc-43k0e.us-west-2.aws.confluent.cloud:9092"); // Hack for now to sandbox cluster
