...
public class IndexerSQLMetadataStorageCoordinatorTest
{
  ...
  public void testTransactionalAnnounceFailDbNullWantNotNull() throws IOException
  {
    ...
    Assert.assertEquals(SegmentPublishResult.fail("java.lang.RetryTransactionException: Aborting transaction!"), result1);
  ...
  public void testTransactionalAnnounceFailDbNotNullWantNull() throws IOException
  {
    ...
    Assert.assertEquals(SegmentPublishResult.fail("java.lang.RetryTransactionException: Aborting transaction!"), result2);
