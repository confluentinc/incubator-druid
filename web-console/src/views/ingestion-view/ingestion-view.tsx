        ...
        >
          ...
          <div className="bottom-pane">
            <ViewControlBar label="Tasks">
              ...
              <Tooltip2
                content="Turning on the toggle will prefer overlord followed by sql for task listing.\
                 Turning off will reverse the order."
                hoverOpenDelay={800}
              >
              <Switch
