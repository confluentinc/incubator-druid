...
{
  private static final Logger LOG = new Logger(JwtConsumer.class);

  private final org.jose4j.jwt.consumer.JwtConsumer JwtComsumer;
  ...
  private static org.jose4j.jwt.consumer.JwtConsumer createConsumer(
      String issuer,
      String jwksUri,
      Set<String> audience
  )
