...
=======
    final KafkaProducer<String, byte[]> producer = EasyMock.createStrictMock(KafkaProducer.class);
>>>>>>> 78e110d851 (wip)
...
=======
      ...
      @Override
      protected void sendToKafka(final String topic, MemoryBoundLinkedBlockingQueue<byte[]> recordQueue,
          Callback callback
      )
      {
